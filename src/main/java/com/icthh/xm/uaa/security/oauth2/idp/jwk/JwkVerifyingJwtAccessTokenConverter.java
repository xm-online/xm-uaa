...
import static com.icthh.xm.uaa.security.oauth2.idp.jwk.JwkAttributes.KEY_ID;
import static com.icthh.xm.uaa.security.oauth2.idp.jwk.JwkAttributes.ALGORITHM;
 ...
 *     <li>Obtain the {@link SignatureVerifier} associated with the {@link JwkDefinition} via the {@link org.springframework.security.oauth2.provider.token.store.jwk.JwkDefinitionSource} and verify the signature.</li>
 * </ol>
 * <br>
 ...
 * will explicitly throw a {@link org.springframework.security.oauth2.provider.token.store.jwk.JwkException} reporting <i>&quot;JWT signing (JWS) is not supported.&quot;</i>.
 * <br>
 * <br>
 *
 ...
 * @author Joe Grandja
 */
public class JwkVerifyingJwtAccessTokenConverter extends JwtAccessTokenConverter {
