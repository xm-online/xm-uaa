...
- [Service Discovery and Configuration with Consul](https://www.jhipster.tech/documentation-archive/v9.0.0-beta.3/microservices-architecture/#consul)
